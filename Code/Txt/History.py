...
class Ui_History(object):
    def setupUi(self, History):
        ...
        self.HistoryPatientName.setStyleSheet(_fromUtf8("color:red;\n"
"font:11pt bold;"))
        ...
        self.HistoryTable1.setStyleSheet(_fromUtf8("background-color: rgb(220, 220, 220);"))
        ...
        self.HistoryTable2.setStyleSheet(_fromUtf8("background-color:white"))
        self.HistoryTable2.setObjectName(_fromUtf8("HistoryTable2"))
        self.HistoryTable2.setColumnCount(12)
        ...
        item = QtGui.QTableWidgetItem()
        self.HistoryTable2.setHorizontalHeaderItem(11, item)
...
"background-color:white;"))
        ...
        self.pushButton_3.setStyleSheet(_fromUtf8("font:bold;\n"
"background-color:white;\n"
""))
    ...
    def retranslateUi(self, History):
        ...
        item.setText(_translate("History", "INVOICE", None))
        ...
        item.setText(_translate("History", "REFILLS", None))
        item = self.HistoryTable2.horizontalHeaderItem(11)
        item.setText(_translate("History", "PRICE2", None))
        self.pushButton.setText(_translate("History", "Refill", None))
        self.pushButton_2.setText(_translate("History", "Print", None))
        self.pushButton_3.setText(_translate("History", "Close", None))
